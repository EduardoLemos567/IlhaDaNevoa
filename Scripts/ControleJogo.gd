...
func pega_posicao_aleatoria() -> Vector2i:
	return Vector2i(
...
func calcula_passos(posicao1 : Vector2i, posicao2 : Vector2i) -> int:
	posicao1 = (posicao1-posicao2).abs()
	return posicao1.x + posicao1.y


func calcula_angulo(posicao : Vector2, tesouro : Vector2) -> float:
